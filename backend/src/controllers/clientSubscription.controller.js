...
class ClientSubscriptionController {
	async getAll(req, res) {
		try {
			console.log('[CLIENT SUB CONTROLLER] GET /client-subscriptions')

			const subscriptions =
				await clientSubscriptionService.getAllSubscriptions()
	...
	async create(req, res) {
		try {
			...
			const subscription = await clientSubscriptionService.createSubscription(
				req.body,
			)
	...
	async getByClient(req, res) {
		try {
			...
			const subs =
				await clientSubscriptionService.getClientSubscriptions(clientId)
